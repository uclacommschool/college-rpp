...
#pathsway database
psd<-read.csv(file.path(".", "psd_dimagiba_march2025.csv")) %>% select(-c())
...
out_4yr<-str_c("UNIVERSITY OF NEVADA LAS VEGAS",
               ...
               "BROWARD COLLEGE", "UNIVERSITY OF ARIZONA", "UNIVERSITY OF GREENWICH",
                sep="|")

private_string<-str_c("ACADEMY OF ART UNIVERSITY", "ALBION COLLEGE",
                "ALFRED UNIVERSITY", "ART CENTER COLLEGE OF DESIGN", 
                "AZUSA PACIFIC UNIVERSITY", "BARNARD COLLEGE", "BELOIT COLLEGE",
                "BOSTON COLLEGE", "BOSTON UNIVERSITY", "BRADLEY UNIVERSITY",
                "BROWN UNIVERSITY","BUCKNELL UNIVERSITY","CALARTS", 
                "CHAMBERLAIN UNIVERSITY", "CARNEGIE MELLON UNIVERSITY",
                "CALIFORNIA LUTHERAN UNIVERSITY","CALTECH","CARLETON COLLEGE",
                "CARNEGIE MELLON UNIVERSITY", "CHAPMAN UNIVERSITY-ORANGE",
                "CHARLES R. DREW UNIVERSITY OF MEDICINE AND SCIENCE",
                "CLAREMONT MCKENNA COLLEGE", "COE COLLEGE", "COLORADO TECHNICAL UNIVERSITY",
                "COLLEGE OF THE REDWOODS", "COLUMBIA UNIVERSITY", "CORNELL UNIVERSITY",
                "CURRY COLLEGE", "DOMINICAN UNIVERSITY OF CALIFORNIA",
                "DREXEL UNIVERSITY","EMORY UNIVERSITY", "FORDHAM UNIVERSITY",
                "FRANKLIN & MARSHALL COLLEGE", "GEORGE WASHINGTON UNIVERSITY",
                "GEORGETOWN UNIVERSITY", "HARVEY MUDD COLLEGE",
                "KALAMAZOO COLLEGE", "LAWRENCE UNIVERSITY", "LEHIGH UNIVERSITY",
                "LEWIS & CLARK COLLEGE", "LOYOLA MARYMOUNT UNIVERSITY",
                "MACLESTER COLLEGE", "MAPUA INSTITUTE OF TECHNOLOGY", "MILLS COLLEGE",
                "MOUNT SAINT MARY'S UNIVERSITY", "MOUNT ST MARY'S COLLEGE",
                "NEW YORK UNIVERSITY","NORTHEASTERN UNIVERSITY",
                "NORTHWESTERN UNIVERSITY", "OBERLIN COLLEGE", "OCCIDENTAL COLLEGE",
                "OTIS COLLEGE OF ART AND DESIGN", "PEPPERDINE UNIVERSITY",
                "PEPPERDINE UNIVERSITY - ONLINE PSYCHOLOG", "PITZER COLLEGE",
                "POMONA COLLEGE", "PRINCETON UNIVERSITY","PURDUE UNIVERSITY",
                "REGENT UNIVERSITY", "SANTA CLARA UNIVERSITY", "SARAH LAWERENCE COLLEGE",
                "SCRIPPS COLLEGE", "ST. OLAF COLLEGE", "STANFORD UNIVERSITY",
                "SWARTHMORE COLLEGE", "SOUTHERN NEW HAMPSHIRE- 09WEEK",
                "TUFTS UNIVERSITY SCHOOL OF ARTS",
                "UNIVERSITY OF CHICAGO", "UNIVERSITY OF LA VERNE SEM TRADITIONAL",
                "UNIVERSITY OF PENNSYLVANIA", "UNIVERSITY OF SAN DIEGO", "UNIVERSIDAD POLITECNICA PUERTO RICO",
                "UNIVERSITY OF SAN FRANCISCO","UNIVERSITY OF SOUTHERN CALIFORNIA",
                "UNIVERSITY OF THE PACIFIC", "VASSAR COLLEGE", "WELLESLEY COLLEGE",
                "WESLEYAN UNIVERSITY","WHITMAN COLLEGE", "WHITTIER COLLEGE",
                "WOODBURY UNIVERSITY","YALE UNIVERSITY", sep="|")
